...
export default function Login() {
  ...
  return (
    <>
      <h2 className="text-3xl font-bold mb-1 text-white leading-tight">Welcome Back</h2>
      <h3 className="text-lg font-semibold mb-3 text-white/80">Login to your account</h3>
      <p className="mb-8 text-white/80 text-base">
        Discover the best job opportunities and continue your journey with Searcheers.
      </p>
      <form className="space-y-5" onSubmit={handleSubmit} autoComplete="off">
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <label htmlFor="remember" className="text-white/90 cursor-pointer text-sm">
            Remember me
          </label>
        </div>
        {/* Button */}
